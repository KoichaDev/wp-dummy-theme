...
function _theme_name_post_metabox_html($post) { 
    ...
    <p>
        <label for="_theme_name_post_layout_field"><?php esc_html_e( 'Layout', '_theme_name' ); ?></label>
        <select name="_theme_name_post_layout_field" id="_theme_name_post_layout_field" class="widefat">
            <option <?php selected( $layout, 'full' ); ?> value="full"><?php esc_html_e( 'Full Width', '_theme_name' ); ?></option>
            <option <?php selected( $layout, 'sidebar' ); ?> value="sidebar"><?php esc_html_e( 'Post With Sidebar', '_theme_name' ); ?></option>
        </select>
    </p>
    <?php 
}
...
function _theme_name_save_post_metabox($post_id, $post) {   
    ...
    if(array_key_exists('_theme_name_post_layout_field', $_POST)) {
        update_post_meta( 
            ...
            sanitize_text_field($_POST['_theme_name_post_layout_field'])
        );
    }
}
